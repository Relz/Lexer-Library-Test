...
TEST(plus_assignment_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(
		L" += ", { TokenInformation(Token::PLUS_ASSIGNMENT, StreamString(L"+=", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		L";+=;",
...
TEST(plus_assignment_token, determining_if_stay_between_numbers)
{
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::FLOAT, StreamString(L"1.1", StreamPosition())),
		  TokenInformation(Token::PLUS_ASSIGNMENT, StreamString(L"+=", StreamPosition(1, 4))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E+1", StreamPosition())),
		  TokenInformation(Token::PLUS_ASSIGNMENT, StreamString(L"+=", StreamPosition(1, 6))),

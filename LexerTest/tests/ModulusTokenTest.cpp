...
TEST(modulus_token, determining_if_stay_alone)
{
	ExpectTokenInformations("%", { TokenInformation(Token::MODULUS, StreamString("%", StreamPosition())) });
}

TEST(modulus_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(" % ", { TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		";%;",
		{ TokenInformation(Token::SEMICOLON, StreamString(";", StreamPosition())),
		  TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 2))),
		  TokenInformation(Token::SEMICOLON, StreamString(";", StreamPosition(1, 3))) });
}

TEST(modulus_token, determining_if_stay_near_delimiter)
{
	ExpectTokenInformations(
		"%;",
		{ TokenInformation(Token::MODULUS, StreamString("%", StreamPosition())),
...
TEST(modulus_token, determining_if_stay_between_numbers)
{
	ExpectTokenInformations(
		"1%1",
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::FLOAT, StreamString("1.1", StreamPosition())),
		  TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 4))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1_E+1", StreamPosition())),
		  TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 6))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString("1.1_E+1", StreamPosition())),
		  TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 8))),
...
TEST(modulus_token, not_determining_if_part_of_modulus_assignment)
{
	ExpectTokenInformations(
		"%=", { TokenInformation(Token::MODULUS_ASSIGNMENT, StreamString("%=", StreamPosition())) });
	ExpectTokenInformations(
		"+%=",
		{ TokenInformation(Token::PLUS, StreamString("+", StreamPosition())),
		  TokenInformation(Token::MODULUS_ASSIGNMENT, StreamString("%=", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		"%=%",
		{ TokenInformation(Token::MODULUS_ASSIGNMENT, StreamString("%=", StreamPosition())),
		  TokenInformation(Token::MODULUS, StreamString("%", StreamPosition(1, 3))) });
}

TEST(modulus_token, not_determining_if_in_character_literal)
{
	ExpectTokenInformations(
		"'%'", { TokenInformation(Token::CHARACTER_LITERAL, StreamString("'%'", StreamPosition())) });
}

TEST(modulus_token, not_determining_if_part_of_string_literal)
{
	ExpectTokenInformations(
...
TEST(modulus_token, not_determining_if_part_of_comment)
{

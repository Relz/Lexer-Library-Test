...
{
	ExpectTokenInformations(L";", { TokenInformation(Token::SEMICOLON, StreamString(L";", StreamPosition())) });
}

TEST(semicolon_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(L" ; ", { TokenInformation(Token::SEMICOLON, StreamString(L";", StreamPosition(1, 2))) });

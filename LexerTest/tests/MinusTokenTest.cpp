...
{
	ExpectTokenInformations(L"-", { TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition())) });
}

TEST(minus_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(L" - ", { TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		L";-;",
		{ TokenInformation(Token::SEMICOLON, StreamString(L";", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 2))),
...
TEST(minus_token, determining_if_stay_near_delimiter)
{
	ExpectTokenInformations(
		L"-;",
		{ TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition())),
...
TEST(minus_token, determining_if_stay_between_numbers)
{
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::FLOAT, StreamString(L"1.1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 4))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 6))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::INTEGER, StreamString(L"1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 2))),
		  TokenInformation(Token::EXPONENTIAL, StreamString(L"1.1_E-1", StreamPosition(1, 3))) });
	ExpectTokenInformations(
		L"1_E-1.1-1",
		{ TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1.1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 8))),
		  TokenInformation(Token::INTEGER, StreamString(L"1", StreamPosition(1, 9))) });
	ExpectTokenInformations(
		L"1-1_E-1.1",
		{ TokenInformation(Token::INTEGER, StreamString(L"1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 2))),
		  TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1.1", StreamPosition(1, 3))) });
	ExpectTokenInformations(
		L"1_E-1-1.1",
		{ TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 6))),
	...
	ExpectTokenInformations(
		...
		{ TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1", StreamPosition())),
		  TokenInformation(Token::MINUS, StreamString(L"-", StreamPosition(1, 6))),
		  TokenInformation(Token::EXPONENTIAL, StreamString(L"1_E-1", StreamPosition(1, 7))) });
}

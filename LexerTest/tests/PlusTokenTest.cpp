...
{
	ExpectTokenInformations(L"+", { TokenInformation(Token::PLUS, StreamString(L"+", StreamPosition())) });
}

TEST(plus_token, determining_if_stay_between_delimiters)
{
	ExpectTokenInformations(L" + ", { TokenInformation(Token::PLUS, StreamString(L"+", StreamPosition(1, 2))) });
	ExpectTokenInformations(
		L";+;",
		{ TokenInformation(Token::SEMICOLON, StreamString(L";", StreamPosition())),
		  TokenInformation(Token::PLUS, StreamString(L"+", StreamPosition(1, 2))),
